  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        {/* Floating WhatsApp Button - Updated with official icon */}
        <a 
          href="https://wa.me/554499449323" 
          target="_blank" 
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#128C7E] text-white p-4 rounded-full shadow-lg shadow-green-500/30 transition-all hover:scale-110 animate-in fade-in zoom-in duration-500 group"
