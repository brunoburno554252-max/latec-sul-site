              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="relative">
                  {currentTestimonial.image ? (
                    ...
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#1B8C3D] to-[#D4A017] flex items-center justify-center ring-4 ring-primary/20">
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`transition-all duration-300 rounded-full ${
                    index === currentIndex
                      ? "w-8 h-3 bg-gradient-to-r from-[#1B8C3D] to-[#D4A017]"
